package com.ll.mq.rabbitmq.client;
...
public class RabbitMqClient {
    ...
    public void initQueue() {
        ...
        for (Map.Entry<String, Object> entry : beansWithRabbitComponentMap.entrySet()) {
            ...
            for (Method method : methods) {
                RabbitListener methodRabbitListener = AnnotationUtils.findAnnotation(method, RabbitListener.class);
    ...
    private void send(String queueName, Object params, Integer expiration) {
        ...
        new Thread(() -> messageListenerContainer.setQueueNames(queueName));
