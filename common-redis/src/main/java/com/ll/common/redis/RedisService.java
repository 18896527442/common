...
public interface RedisService<K, V> {
     ...
     * @return
     */
    Long addZSet(K key, Set<ZSetOperations.TypedTuple<V>> value);
    ...
    /**
     * 缓存过期时，通过 SetNX  获取锁，如果成功了，那么更新缓存，然后删除锁
     * @param key
     * @param value
     * @param second
     * @return
     */
    boolean setnx(String key, Object value, Long second);
    ...
    Long increment(String key, Long step, Long time);
     ...
     * @return
     */
    Long deIncrement(String key);

    Long deIncrement(String key, Long step, Long time);
