...
public class ShortUrlUtils {
    ...
    public static void main(String[] args) {
        String sLongUrl = "https://www.baidu.com/"; // 长链接
    ...
    public static String[] shortUrl(String url) {
        ...
        String key = "perk-pushplus";                               // 可以自定义生成 MD5 加密字符传前的混合加密key
        String sMD5EncryptResult = SecureUtil.md5(key + url);       // 对传入网址进行 MD5 加密，key是加密字符串
